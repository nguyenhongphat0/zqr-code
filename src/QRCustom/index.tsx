...
import { rand, defaultViewBox, getTypeTable, QRPointType, RendererWrapper, RendererProps, SFC } from 'react-qrbtf';
...
function drawIcon({ qrcode, title, titleSize, titleColor, titleAlign, icon, iconScale = .33, styles }: RendererProps) {
  if (!qrcode) return []
